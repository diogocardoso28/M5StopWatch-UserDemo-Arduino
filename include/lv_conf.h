...
/* clang-format off */
#if 1 /* M5StopWatch Arduino port configuration */
...
#if LV_USE_FS_STDIO
    #define LV_FS_STDIO_LETTER 'A'      /**< Badge images are addressed as A:/spiflash/... */
    #define LV_FS_STDIO_PATH ""         /**< Set the working directory. File/directory paths will be appended to it. */
    #define LV_FS_STDIO_CACHE_SIZE (1024 * 1024)
#endif
